...
##P8HPCZWEGmaZ7/K1
##L8/UAdDXTlaDjofG5iZk2UbjQ3EtZ8CXvYqDwZK36+X8hxXWXp8GWlxymiW8N0ivUOIGRskUodUYQR8vLuYvzvzVA+LJ
##Kc/BRM3KXxU=
##
##
...
#Auditbeat Download URL
$url = 'https://artifacts.elastic.co/downloads/beats/auditbeat/auditbeat-6.5.4-windows-x86_64.zip'

#Creates folder where Zip file will be temporarily stored
New-Item -ItemType Directory -Path 'c:\auditbeat' -Force

$Dest = 'C:\auditbeat\auditbeat.zip'
...
Remove-Item -LiteralPath 'c:\auditbeat' -Recurse -Confirm:$false

#Renames auditbeat-6.5.4-windows-x86_64 to auditbeat
Rename-Item 'C:\auditbeat-6.5.4-windows-x86_64' 'C:\auditbeat'
...
$lineNumber = 67
$fileContent = Get-Content auditbeat.yml
$fileContent[$lineNumber-1] += "  username: ""$($objTextBox2.Text)"""
$fileContent | Set-Content auditbeat.yml
...
#Open Kibana after auditbeat has successfully installed and is running
